...
export const getPatients = createAsyncThunk<Patient[], void, { rejectValue: string }>(
  ...
  export const postPatient = createAsyncThunk<Patient[], { id: number, name: string, lastname: string, cel: number, insurance: string; }, { rejectValue: string }>(
  ...
  export const deletePatient = createAsyncThunk<Patient[], {  id: string }, { rejectValue: string }>(
